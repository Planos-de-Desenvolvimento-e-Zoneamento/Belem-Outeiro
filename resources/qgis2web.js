...
map.getView().fit([-5400065.044533, -143365.207788, -5394890.369267, -140463.902531], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Zoneamento do PDZ do Porto de Belém - Terminal Outeiro</h2>';
        return titleElement;
    })(),
